...
from transformer.config import get_weights_file_path, latest_weights_file_path
...
def train_model(config):
    ...
    if (device == 'cuda'):
        ...
        print(f"NOTE: If you have a GPU, consider it for training.")
    ...
    # If user specified a model to preload
    initial_epoch = 0
    global_step = 0
    ...
    if model_filename:
        ...
        print('No model to preload, starting from scrath')